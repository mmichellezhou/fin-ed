...
import { ArrowRight, BookOpen, Target, Users, TrendingUp, Star, Shield, UserCheck, Trophy, Briefcase, GraduationCap } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Tailored content for kids, teens, young adults, adults, and seniors"
    },
    {
      icon: Target,
      title: "Interactive Quizzes",
      description: "Test your knowledge with AI-generated quizzes after each lesson"
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      icon: Shield,
      title: "100% Free",
      description: "Quality financial education accessible to everyone, always free"
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-background via-accent/10 to-primary/5 py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed">
              Master money management with personalized lessons, interactive quizzes, and progress tracking. 
              Start your financial literacy journey today—completely free.
            </p>
        ...
        <div className="absolute top-40 right-16 w-12 h-12 bg-secondary/10 rounded-full float-animation" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-20 left-1/4 w-8 h-8 bg-warning/10 rounded-full float-animation" style={{ animationDelay: '2s' }} />
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We make financial literacy accessible, engaging, and effective for learners of all ages
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto mb-12 leading-relaxed">
              ...
              FinEd bridges this gap by providing comprehensive, age-appropriate financial education that 
              empowers people to make informed decisions about their money throughout their lives.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">Content adapted to your age group and financial goals</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Achievement Tracking</h3>
                <p className="text-muted-foreground text-sm">Earn badges and certificates as you progress</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">Get help from our AI assistant and fellow learners</p>
              </div>
            </div>
          </div>
        </div>
